...
public class DeleteArticleBySlugImpl implements DeleteArticleBySlug {
  ...
  @Inject private FindArticleByAuthorAndSlug findArticleByAuthorAndSlug;
  ...
  public void handle(UUID authorId, String slug) {
    ...
    Optional<FavoriteRelationship> favorite =
        favoriteRelationshipRepository.findByArticleIdAndUserId(article.getId(), authorId);
    favorite.ifPresent(
        favoriteRelationship -> favoriteRelationshipRepository.delete(favoriteRelationship));
