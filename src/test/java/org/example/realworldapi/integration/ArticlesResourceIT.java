...
import org.example.realworldapi.AbstractIT;
...
public class ArticlesResourceIT extends AbstractIT {
  ...
  public void
    ...
    NewArticleRequestWrapper newArticleRequestWrapper =
        new NewArticleRequestWrapper(newArticleRequest);
  ...
  public void
    ...
    UpdateArticleRequestWrapper updateArticleRequestWrapper =
        new UpdateArticleRequestWrapper(updateArticleRequest);
  ...
  @Test
  public void
      givenExistentArticle_whenExecuteDeleteArticlWithCommentsEndpoint_shouldReturnStatusCode200() {
    final var loggedUser =
        createUserEntity("loggedUser", "loggeduser@mail.com", "bio", "image", "loggeduser123");
    final var article = createArticleEntity(loggedUser, "Title", "Description", "Body");
  ...
  public void
    ...
    NewCommentRequestWrapper newCommentRequestWrapper =
        new NewCommentRequestWrapper(newCommentRequest);
